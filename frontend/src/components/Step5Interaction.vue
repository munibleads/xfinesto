          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report generation agent with access to 4 professional tools and complete XFinesto memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation environment state, combining Global/Local Memory mechanisms for deep cross-temporal causal analysis</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface optimized for index efficiency, used to quickly extract specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews capable of conducting multi-round parallel conversations with simulated world individuals, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Fix non-consecutive ordered list numbering: when single <ol> is separated by paragraph content, keep numbering incremental
