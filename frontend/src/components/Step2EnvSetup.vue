    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Combined with context, automatically calls tools to organize entities and relations from knowledge graph, initialize simulation individuals, and give them unique behaviors and memories based on reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently sets world time flow rate, recommendation algorithms, each individual's active time periods, posting frequency, event triggers, etc. based on simulation requirements and reality seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                <div class="config-item">
                  <span class="config-item-label">Simulation Hours</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Rec. Algorithm Config</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Recency Wt.</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Popularity Wt.</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Relevance Wt.</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Simulation environment preparation complete. You can now start running the simulation.</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">XFinesto auto-plans to simulate reality for <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours, each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of real time</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For first-time runs, strongly recommend switching to 'Custom Mode' to reduce simulation rounds for quick preview and lower error risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generating Agent Profiles' || newStage === 'generating_profiles') {
    ...
    if (!configTimer) {
      addLog('Started generating dual-platform simulation config...')
      startConfigPolling()
    }
  } else if (newStage === 'Preparing Simulation Script' || newStage === 'copying_scripts') {
    phase.value = 2 // Still belongs to config stage
  }
})

// Compute auto-generated rounds (do not use hardcoded default value)
...
// Compute total topics count for all profiles
...
const handleStartSimulation = () => {
  // Construct params to pass to parent component
  const params = {}
  
  if (useCustomRounds.value) {
    // User customized rounds, pass maxRounds param
    params.maxRounds = customMaxRounds.value
    addLog(`Starting simulation, custom rounds: ${customMaxRounds.value} rounds`)
  } else {
    // User chose to keep auto-generated rounds, do not pass maxRounds param
    addLog(`Starting simulation, using auto-config rounds: ${autoGeneratedRounds.value} rounds`)
  }
...
const startPrepareSimulation = async () => {
  ...
  // Mark first step as completed, start second step
  phase.value = 1
