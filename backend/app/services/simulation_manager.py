...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation config parameters (time, activity, frequency, etc.)
        ...
        try:
            ...
            # Note: Reddit already saved in real-time during generation, save again here to ensure completeness
            # Note: Twitter uses CSV format! This is OASIS requirement
            if progress_callback:
                progress_callback(
