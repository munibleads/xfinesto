    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Target platform (optional)
                ...
                - None: For dual-platform simulations, interview both; for single-platform, interview that platform
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden per interview item)
                ...
                - None: For dual-platform simulations, each agent interviews both platforms
            timeout: Timeout in seconds
