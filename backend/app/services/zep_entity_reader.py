...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node has only one "Entity" label, it doesn't match our predefined type, skip
        - If a node has labels other than "Entity" and "Node", it matches predefined type, keep
